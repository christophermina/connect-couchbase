...
module.exports = function(session){
    ...
    function CouchbaseStore(options) {
        ...
        this.client = options.client || new Couchbase.Connection(connectOptions, function(err){
            if (err) {
        ...
        if (options.hasOwnProperty("ttl") && options.ttl == null) {
            this.ttl = null;
        } else {
    ...
    CouchbaseStore.prototype.set = function(sid, sess, fn){
        ...
        try {
            ...
            this.client.set(sid, sess, {expiry:ttl}, function(err){
